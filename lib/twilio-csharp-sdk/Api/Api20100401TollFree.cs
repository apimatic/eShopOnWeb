...
public sealed class Api20100401TollFree
{
    private readonly RawClient _rawClient;
    private readonly Server _server;
    private readonly AuthSchemes _auth;

    internal Api20100401TollFree(RawClient rawClient, Server server, AuthSchemes auth)
    {
    ...
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ListAvailablePhoneNumberTollFreeResponse"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task<ListAvailablePhoneNumberTollFreeResponse> ListAvailablePhoneNumberTollFree(string accountSid,
        string countryCode,
        int? areaCode,
        string? contains,
        bool? smsEnabled,
        ...
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/TollFree.json"),
            ...
            HttpMethod.Get,
            EmptyBody.Instance,
            JsonResponse.Create<ListAvailablePhoneNumberTollFreeResponse>(),
