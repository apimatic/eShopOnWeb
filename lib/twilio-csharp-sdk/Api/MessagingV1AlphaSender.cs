...
public sealed class MessagingV1AlphaSender
{
    private readonly RawClient _rawClient;
    private readonly Server _server;
    private readonly AuthSchemes _auth;

    internal MessagingV1AlphaSender(RawClient rawClient, Server server, AuthSchemes auth)
    {
    ...
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="MessagingV1ServiceAlphaSender"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task<MessagingV1ServiceAlphaSender> CreateAlphaSender(string serviceSid,
        string alphaSender,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default1("/v1/Services/{ServiceSid}/AlphaSenders"),
            [new TemplateParam("ServiceSid", serviceSid)],
            [],
            [new HeaderParam("Idempotency-Key", Guid.NewGuid())],
            HttpMethod.Post,
            FormUrlEncodedRequest.Create([new Param("AlphaSender", alphaSender)]),
            JsonResponse.Create<MessagingV1ServiceAlphaSender>(),
    ...
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task DeleteAlphaSender(string serviceSid,
        string sid,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default1("/v1/Services/{ServiceSid}/AlphaSenders/{Sid}"),
    ...
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="MessagingV1ServiceAlphaSender"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task<MessagingV1ServiceAlphaSender> FetchAlphaSender(string serviceSid,
        string sid,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default1("/v1/Services/{ServiceSid}/AlphaSenders/{Sid}"),
    ...
    /// <param name="requestOptions">Per-request options, such as an overriding log level for this call</param>
    /// <param name="ct">Cancellation token</param>
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ListAlphaSenderResponse"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task<ListAlphaSenderResponse> ListAlphaSender(string serviceSid,
        long? pageSize,
        int? page,
        string? pageToken,
        RequestOptions? requestOptions = null,
        ...
        _rawClient.Execute(_server.Default1("/v1/Services/{ServiceSid}/AlphaSenders"),
            ...
            HttpMethod.Get,
            EmptyBody.Instance,
            JsonResponse.Create<ListAlphaSenderResponse>(),
            RawErrorResponse.Instance,
            [_auth.AccountSidAuthToken],
            requestOptions,
            ct);
