...
public sealed class Api20100401Record
{
    private readonly RawClient _rawClient;
    private readonly Server _server;
    private readonly AuthSchemes _auth;

    internal Api20100401Record(RawClient rawClient, Server server, AuthSchemes auth)
    {
    ...
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ListUsageRecordResponse"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    /// <remarks>
    /// Retrieve a list of usage-records belonging to the account used to make the request
    /// </remarks>
    public Task<ListUsageRecordResponse> ListUsageRecord(string accountSid,
        string? category,
        ...
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/Usage/Records.json"),
            ...
            HttpMethod.Get,
            EmptyBody.Instance,
            JsonResponse.Create<ListUsageRecordResponse>(),
