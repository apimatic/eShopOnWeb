...
public record StudioV1FlowExecutionExecutionContext
{
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the ExecutionContext resource.
    /// </summary>
