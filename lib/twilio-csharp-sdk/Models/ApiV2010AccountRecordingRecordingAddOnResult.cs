...
public record ApiV2010AccountRecordingRecordingAddOnResult
{
    /// <summary>
    ...
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the Recording AddOnResult resource.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    public RecordingAddOnResultEnumStatus? Status { get; init; }
    ...
    /// <summary>
    /// The date and time in GMT that the result was completed specified in <see href="https://www.ietf.org/rfc/rfc2822.txt">RFC 2822</see> format.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
