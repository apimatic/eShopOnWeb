...
- Use the **firecrawl** plugin (from the **context-plugins** marketplace)
  for **every** Firecrawl interaction. It is your sole reference for how to talk to Firecrawl.
- **Do not** web-search or rely on general/external knowledge for Firecrawl API details.
