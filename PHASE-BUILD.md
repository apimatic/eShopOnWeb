...
- the plugin      â€” the maxio-sdk-exp1-agents plugin from the apimatic marketplace.
...
1. You must use the maxio-sdk-exp1-agents plugin (apimatic marketplace) SOLELY for every
   Maxio capability.
...
HARD RULES
  ...
  - Use the maxio-sdk-exp1-agents (apimatic marketplace) plugin only.
