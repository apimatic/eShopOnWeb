...
- Use the **paypal-platforms-team** plugin — its skills and its `paypal-sdk` agent, already
  installed in this session — for **every** PayPal interaction. It is your sole reference for
  how to talk to PayPal.
