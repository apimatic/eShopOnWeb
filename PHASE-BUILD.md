...
- You are given **no** Twilio plugin and **no** bundled specification. Sourcing the Twilio
  contract is part of the task: **research and confirm** the correct, current way to perform
  every Twilio capability this integration requires **before** writing code against it.
  Official Twilio documentation and web search are available to you; how you consume them —
...
- Confirm before you commit: do not build against endpoints, fields, or shapes you have not
  verified against a real Twilio source.
- If you cannot confirm how a required capability works, or find that Twilio does not support
