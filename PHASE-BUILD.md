...
- You are given **no** PayPal plugin and **no** bundled specification. Sourcing the PayPal
  ...
  Official PayPal documentation and web search are available to you; how you consume them —
...
- Confirm before you commit: do not build against endpoints, fields, or shapes you have not
  verified against a real PayPal source.
