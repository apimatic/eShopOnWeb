...
- the plugin      â€” the maxio-sdk-clone plugin from the apimatic marketplace.
...
1. You must use the maxio-sdk-clone plugin (apimatic marketplace) SOLELY for every
   Maxio capability.
...
HARD RULES
  ...
  - Use the maxio-sdk-clone (apimatic marketplace) plugin only.
