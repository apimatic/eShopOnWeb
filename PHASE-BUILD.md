...
- the plugin      â€” the maxio-sdk-merged plugin from the apimatic marketplace.
...
1. You must use the maxio-sdk-merged plugin (apimatic marketplace) SOLELY for every
   Maxio capability.
...
HARD RULES
  ...
  - Use the maxio-sdk-merged (apimatic marketplace) plugin only.
