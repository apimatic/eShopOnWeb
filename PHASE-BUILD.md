...
- You are given **no** Firecrawl plugin and **no** bundled specification. Sourcing the
  Firecrawl contract is part of the task: **research and confirm** the correct, current way to
  perform every Firecrawl capability this integration requires **before** writing code against
  it. Official Firecrawl documentation and web search are available to you; how you consume
  them — and whether you use an SDK/package or plain HTTP — is your call.
- Confirm before you commit: do not build against endpoints, fields, or shapes you have not
  verified against a real Firecrawl source.
- If you cannot confirm how a required capability works, or find that Firecrawl does not
  support something the integration needs, **STOP and report the gap** — do not invent or work
  around it.
---
