...
- the plugin      â€” the maxio-sdk plugin from the v4-sdk-marketplace marketplace.
...
1. You must use the maxio-sdk plugin (v4-sdk-marketplace marketplace) SOLELY for every
   Maxio capability.
...
HARD RULES
  ...
  - Use the maxio-sdk (v4-sdk-marketplace marketplace) plugin only.
