...
## Sandbox entities (already seeded on the site from `MAXIO_SITE_SUBDOMAIN`)
...
|--------|--------|--------------|-------|
| Product Family | from `MAXIO_DEFAULT_PRODUCT_FAMILY` | 3023074 | Container for the plans + component |
