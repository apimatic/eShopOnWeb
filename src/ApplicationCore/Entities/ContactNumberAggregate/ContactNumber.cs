...
/// number (as returned by the carrier lookup), not whatever the caller typed.
...
public class ContactNumber : BaseEntity, IAggregateRoot
{
    ...
    /// <summary>Canonical E.164 destination. Treated as sensitive: never written to logs.</summary>
