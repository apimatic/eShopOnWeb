...
public class Buyer : BaseEntity, IAggregateRoot
{
    ...
    public PaymentMethod AddPaymentMethod(string cardId, string? last4, string? brand, string? expiry, string? alias)
    {
        Guard.Against.NullOrEmpty(cardId, nameof(cardId));
        var method = new PaymentMethod(cardId, last4, brand, expiry, alias);
