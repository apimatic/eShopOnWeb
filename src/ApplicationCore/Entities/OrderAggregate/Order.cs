...
public class Order : BaseEntity, IAggregateRoot
{
    ...
    public decimal RefundableAmount()
    {
        ...
        var remaining = CapturedAmount.Value - RefundedAmount();
    ...
    public OrderRefund AddRefund(string idempotencyKey, decimal amount, string? payPalRefundId, string status)
    {
        var refund = new OrderRefund(idempotencyKey, amount, payPalRefundId, status);
        _refunds.Add(refund);
    ...
    public void RecalculateRefundStatus()
    {
        ...
        if (CapturedAmount is null || refunded < CapturedAmount.Value)
        {
