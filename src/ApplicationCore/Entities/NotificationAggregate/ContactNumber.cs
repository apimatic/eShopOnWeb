...
/// established at registration time; it is treated as PII and is never written to logs.
/// </summary>
...
#pragma warning restore CS8618
    ...
    /// <summary>Provider-canonical E.164 form of the number (what the provider returned, not what the caller typed).</summary>
