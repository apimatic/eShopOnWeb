...
/// <see cref="PhoneNumber"/> is the provider's own canonical (E.164) form, not whatever the caller typed.
...
#pragma warning restore CS8618
    ...
    /// <summary>The owning shopper — the username/email carried on the token, matching <c>Order.BuyerId</c>.</summary>
