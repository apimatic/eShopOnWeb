...
/// The value stored is the messaging provider's own canonical (E.164) form of the number,
/// not whatever the caller typed. A number belongs to the shopper who registered it
/// (<see cref="BuyerId"/> equals the authenticated username).
/// </summary>
