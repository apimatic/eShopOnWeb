...
/// <summary>
/// A card the shopper vaulted with PayPal. Only safe display data is stored here
/// (brand, last digits, expiry); the full card details live exclusively in
/// PayPal's vault and are referenced by the vault token id.
/// </summary>
