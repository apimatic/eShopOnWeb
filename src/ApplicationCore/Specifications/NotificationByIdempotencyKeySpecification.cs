...
/// <summary>Finds a notification produced under a given resend idempotency key, so repeating a
/// resend under the same key does not send a second message.</summary>
