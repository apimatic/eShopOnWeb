...
/// <summary>
/// Loads a single order with its items and full payment state (hold, capture, refunds). Optionally
/// scoped to a buyer so a shopper can only ever load their own order.
/// </summary>
