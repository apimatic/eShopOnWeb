...
/// <summary>
/// The notification a previous resend request under this idempotency key produced, if any. Used
/// to make repeat resend requests under the same key send no second message.
/// </summary>
