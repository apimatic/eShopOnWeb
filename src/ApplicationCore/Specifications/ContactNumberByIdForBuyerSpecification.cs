...
/// <summary>
/// A single contact number, but only if it belongs to the given shopper. Scoping the lookup this way
/// means one shopper can never see, use or delete another's number.
/// </summary>
