...
/// <summary>
/// A single contact number by id, but only if it belongs to the given shopper. Scoping ownership into
/// the query means one shopper can never read or delete another's number.
/// </summary>
