...
public class OrderService : IOrderService
{
    ...
    public async Task<Order> CreateOrderFromItemsAsync(string buyerId, Address shippingAddress, IReadOnlyList<OrderItemRequest> items)
    {
        ...
        var orderItems = items.Select(item =>
        {
            ...
            Guard.Against.Null(catalogItem, nameof(item.CatalogItemId), $"Catalog item {item.CatalogItemId} does not exist.");
