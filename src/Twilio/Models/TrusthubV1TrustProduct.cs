...
public record TrusthubV1TrustProduct
{
    /// <summary>
    ...
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the Trust Product resource.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    public TrustProductEnumStatus? Status { get; init; }

    /// <summary>
    /// The date and time in GMT in <see href="https://en.wikipedia.org/wiki/ISO_8601">ISO 8601</see> format until which the resource will be valid.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
