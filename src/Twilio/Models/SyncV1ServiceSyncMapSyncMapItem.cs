...
public record SyncV1ServiceSyncMapSyncMapItem
{
    /// <summary>
    ...
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the Map Item resource.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("map_sid")]
    [StringLength(34, MinimumLength = 34)]
    [RegularExpression("^MP[0-9a-fA-F]{32}$")]
    ...
    /// <summary>
    /// The date and time in GMT when the Map Item expires and will be deleted, specified in <see href="https://en.wikipedia.org/wiki/ISO_8601">ISO 8601</see> format. If the Map Item does not expire, this value is <c>null</c>.  The Map Item might not be deleted immediately after it expires.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    /// <summary>
    /// The identity of the Map Item's creator. If the Map Item is created from the client SDK, the value matches the Access Token's <c>identity</c> field. If the Map Item was created from the REST API, the value is <c>system</c>.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
