...
public record SyncV1ServiceSyncMapSyncMapPermission
{
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the Sync Map Permission resource.
    /// </summary>
