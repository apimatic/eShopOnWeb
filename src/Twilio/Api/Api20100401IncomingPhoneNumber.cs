...
public sealed class Api20100401IncomingPhoneNumber
{
    private readonly RawClient _rawClient;
    private readonly Server _server;
    private readonly AuthSchemes _auth;

    internal Api20100401IncomingPhoneNumber(RawClient rawClient, Server server, AuthSchemes auth)
    {
    ...
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ApiV2010AccountIncomingPhoneNumber"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    /// <remarks>
    /// Purchase a phone-number for the account.
    /// </remarks>
    public Task<ApiV2010AccountIncomingPhoneNumber> CreateIncomingPhoneNumber(string accountSid,
        string? apiVersion,
        string? friendlyName,
        ...
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers.json"),
            ...
            JsonResponse.Create<ApiV2010AccountIncomingPhoneNumber>(),
    ...
    /// </summary>
    /// <param name="accountSid">The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the IncomingPhoneNumber resources to delete.</param>
    /// <param name="sid">The Twilio-provided string that uniquely identifies the IncomingPhoneNumber resource to delete.</param>
    /// <param name="requestOptions">Per-request options, such as an overriding log level for this call</param>
    /// <param name="ct">Cancellation token</param>
    ...
    /// Delete a phone-numbers belonging to the account used to make the request.
    /// </remarks>
    public Task DeleteIncomingPhoneNumber(string accountSid,
        string sid,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/{Sid}.json"),
    ...
    /// </summary>
    /// <param name="accountSid">The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the IncomingPhoneNumber resource to fetch.</param>
    /// <param name="sid">The Twilio-provided string that uniquely identifies the IncomingPhoneNumber resource to fetch.</param>
    /// <param name="requestOptions">Per-request options, such as an overriding log level for this call</param>
    /// <param name="ct">Cancellation token</param>
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ApiV2010AccountIncomingPhoneNumber"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    ...
    /// Fetch an incoming-phone-number belonging to the account used to make the request.
    /// </remarks>
    public Task<ApiV2010AccountIncomingPhoneNumber> FetchIncomingPhoneNumber(string accountSid,
        string sid,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/{Sid}.json"),
    ...
    /// </summary>
    /// <param name="accountSid">The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the IncomingPhoneNumber resources to read.</param>
    ...
    /// <param name="requestOptions">Per-request options, such as an overriding log level for this call</param>
    /// <param name="ct">Cancellation token</param>
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ListIncomingPhoneNumberResponse"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    /// <remarks>
    /// Retrieve a list of incoming-phone-numbers belonging to the account used to make the request.
    /// </remarks>
    public Task<ListIncomingPhoneNumberResponse> ListIncomingPhoneNumber(string accountSid,
        bool? beta,
        string? friendlyName,
        string? phoneNumber,
        string? origin,
        ...
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers.json"),
            ...
            HttpMethod.Get,
            EmptyBody.Instance,
            JsonResponse.Create<ListIncomingPhoneNumberResponse>(),
            RawErrorResponse.Instance,
            [_auth.AccountSidAuthToken],
            requestOptions,
            ct);
    ...
    /// </summary>
    /// <param name="accountSidTemplate">The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the IncomingPhoneNumber resource to update.  For more information, see <see href="https://www.twilio.com/docs/iam/api/subaccounts#exchanging-numbers">Exchanging Numbers Between Subaccounts</see>.</param>
    /// <param name="sid">The Twilio-provided string that uniquely identifies the IncomingPhoneNumber resource to update.</param>
    ...
    /// Update an incoming-phone-number instance.
    /// </remarks>
    public Task<ApiV2010AccountIncomingPhoneNumber> UpdateIncomingPhoneNumber(string accountSidTemplate,
        string sid,
        string? accountSid,
        string? apiVersion,
        string? friendlyName,
        ...
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/{Sid}.json"),
            [new TemplateParam("AccountSid", accountSidTemplate), new TemplateParam("Sid", sid)],
            [],
            [new HeaderParam("Idempotency-Key", Guid.NewGuid())],
            HttpMethod.Post,
            FormUrlEncodedRequest.Create([new Param("AccountSid", accountSid),
