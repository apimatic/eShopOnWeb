...
public record ApiV2010AccountIncomingPhoneNumber
{
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created this IncomingPhoneNumber resource.
    /// </summary>
    ...
    public IncomingPhoneNumberEnumAddressRequirement? AddressRequirements { get; init; }
    ...
    public IncomingPhoneNumberEnumVoiceReceiveMode? VoiceReceiveMode { get; init; }
    ...
    public IncomingPhoneNumberEnumEmergencyStatus? EmergencyStatus { get; init; }
    ...
    public IncomingPhoneNumberEnumEmergencyAddressStatus? EmergencyAddressStatus { get; init; }
