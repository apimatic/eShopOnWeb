...
public record FlexV1WebChannel
{
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the WebChannel resource and owns this Workflow.
    /// </summary>
