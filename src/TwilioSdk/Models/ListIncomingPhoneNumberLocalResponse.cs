...
public record ListIncomingPhoneNumberLocalResponse
{
    ...
    public IReadOnlyList<ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal>? IncomingPhoneNumbers { get; init; }
