...
public record ListRecordingAddOnResultResponse
{
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("add_on_results")]
    public IReadOnlyList<ApiV2010AccountRecordingRecordingAddOnResult>? AddOnResults { get; init; }
