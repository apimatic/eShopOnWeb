...
public record ListIncomingPhoneNumberMobileResponse
{
    ...
    public IReadOnlyList<ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile>? IncomingPhoneNumbers { get; init; }
