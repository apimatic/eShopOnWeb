...
public record SipAuthCallsIpAccessControlListMapping
{
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the IpAccessControlListMapping resource.
    /// </summary>
