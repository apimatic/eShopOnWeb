...
public record SyncV1ServiceSyncList
{
    /// <summary>
    ...
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the Sync List resource.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    /// <summary>
    /// The date and time in GMT when the Sync List expires and will be deleted, specified in <see href="https://en.wikipedia.org/wiki/ISO_8601">ISO 8601</see> format. If the Sync List does not expire, this value is <c>null</c>. The Sync List might not be deleted immediately after it expires.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    /// <summary>
    /// The identity of the Sync List's creator. If the Sync List is created from the client SDK, the value matches the Access Token's <c>identity</c> field. If the Sync List was created from the REST API, the value is <c>system</c>.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
