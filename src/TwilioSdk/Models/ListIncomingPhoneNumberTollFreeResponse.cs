...
public record ListIncomingPhoneNumberTollFreeResponse
{
    ...
    public IReadOnlyList<ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree>? IncomingPhoneNumbers { get; init; }
