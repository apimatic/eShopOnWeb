...
public record VideoV1RoomRoomParticipant
{
    /// <summary>
    ...
    public RoomParticipantEnumStatus? Status { get; init; }

    /// <summary>
    /// The application-defined string that uniquely identifies the resource's User within a Room. If a client joins with an existing Identity, the existing client is disconnected. See <see href="https://www.twilio.com/docs/video/tutorials/user-identity-access-tokens">access tokens</see> and <see href="https://www.twilio.com/docs/video/programmable-video-limits">limits</see> for more info.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
