...
public record TaskrouterV1WorkspaceWorkerWorkerReservation
{
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the WorkerReservation resource.
    /// </summary>
    ...
    public WorkerReservationEnumStatus? ReservationStatus { get; init; }
