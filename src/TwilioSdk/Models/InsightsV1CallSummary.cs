...
public record InsightsV1CallSummary
{
    /// <summary>
    ...
    public SummaryEnumCallType? CallType { get; init; }

    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("call_state")]
    public SummaryEnumCallState? CallState { get; init; }

    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("answered_by")]
    public SummaryEnumAnsweredBy? AnsweredBy { get; init; }

    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("processing_state")]
    public SummaryEnumProcessingState? ProcessingState { get; init; }
