...
public record ListOutgoingCallerIdResponse
{
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("outgoing_caller_ids")]
    public IReadOnlyList<ApiV2010AccountOutgoingCallerId>? OutgoingCallerIds { get; init; }
