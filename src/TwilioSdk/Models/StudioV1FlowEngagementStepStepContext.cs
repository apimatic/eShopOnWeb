...
public record StudioV1FlowEngagementStepStepContext
{
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the StepContext resource.
    /// </summary>
