...
public sealed class Api20100401Siprec
{
    private readonly RawClient _rawClient;
    private readonly Server _server;
    private readonly AuthSchemes _auth;

    internal Api20100401Siprec(RawClient rawClient, Server server, AuthSchemes auth)
    {
    ...
    /// Create a Siprec
    /// </summary>
    /// <param name="accountSid">The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created this Siprec resource.</param>
    /// <param name="callSid">The SID of the <see href="https://www.twilio.com/docs/voice/api/call-resource">Call</see> the Siprec resource is associated with.</param>
    ...
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ApiV2010AccountCallSiprec"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    /// <remarks>
    /// Create a Siprec
    /// </remarks>
    public Task<ApiV2010AccountCallSiprec> CreateSiprec(string accountSid,
        string callSid,
        string? name,
        ...
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Siprec.json"),
            ...
            FormUrlEncodedRequest.Create([new Param("Name", name),
                    new Param("ConnectorName", connectorName),
            ...
            JsonResponse.Create<ApiV2010AccountCallSiprec>(),
    ...
    /// <summary>
    /// Stop a Siprec using either the SID of the Siprec resource or the <c>name</c> used when creating the resource
    /// </summary>
    /// <param name="accountSid">The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created this Siprec resource.</param>
    /// <param name="callSid">The SID of the <see href="https://www.twilio.com/docs/voice/api/call-resource">Call</see> the Siprec resource is associated with.</param>
    /// <param name="sid">The SID of the Siprec resource, or the <c>name</c> used when creating the resource</param>
    ...
    /// Stop a Siprec using either the SID of the Siprec resource or the <c>name</c> used when creating the resource
    /// </remarks>
    public Task<ApiV2010AccountCallSiprec> UpdateSiprec(string accountSid,
        string callSid,
        string sid,
        SiprecEnumUpdateStatus status,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Siprec/{Sid}.json"),
