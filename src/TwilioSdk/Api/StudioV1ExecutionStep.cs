...
public sealed class StudioV1ExecutionStep
{
    private readonly RawClient _rawClient;
    private readonly Server _server;
    private readonly AuthSchemes _auth;

    internal StudioV1ExecutionStep(RawClient rawClient, Server server, AuthSchemes auth)
    {
    ...
    /// Retrieve a Step.
    /// </remarks>
    public Task<StudioV1FlowExecutionExecutionStep> FetchExecutionStep(string flowSid,
        string executionSid,
        string sid,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default11("/v1/Flows/{FlowSid}/Executions/{ExecutionSid}/Steps/{Sid}"),
    ...
    /// Retrieve a list of all Steps for an Execution.
    /// </remarks>
    public Task<ListExecutionStepResponse> ListExecutionStep(string flowSid,
        string executionSid,
        long? pageSize,
        int? page,
        string? pageToken,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default11("/v1/Flows/{FlowSid}/Executions/{ExecutionSid}/Steps"),
