...
public sealed class Api20100401Yearly
{
    private readonly RawClient _rawClient;
    private readonly Server _server;
    private readonly AuthSchemes _auth;

    internal Api20100401Yearly(RawClient rawClient, Server server, AuthSchemes auth)
    {
    ...
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ListUsageRecordYearlyResponse"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task<ListUsageRecordYearlyResponse> ListUsageRecordYearly(string accountSid,
        string? category,
        ...
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/Usage/Records/Yearly.json"),
            ...
            HttpMethod.Get,
            EmptyBody.Instance,
            JsonResponse.Create<ListUsageRecordYearlyResponse>(),
