...
public sealed class TaskrouterV1TaskReservation
{
    private readonly RawClient _rawClient;
    private readonly Server _server;
    private readonly AuthSchemes _auth;

    internal TaskrouterV1TaskReservation(RawClient rawClient, Server server, AuthSchemes auth)
    {
    ...
    /// </summary>
    /// <param name="workspaceSid">The SID of the Workspace with the TaskReservation resource to fetch.</param>
    /// <param name="taskSid">The SID of the reserved Task resource with the TaskReservation resource to fetch.</param>
    /// <param name="sid">The SID of the TaskReservation resource to fetch.</param>
    /// <param name="requestOptions">Per-request options, such as an overriding log level for this call</param>
    /// <param name="ct">Cancellation token</param>
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="TaskrouterV1WorkspaceTaskTaskReservation"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task<TaskrouterV1WorkspaceTaskTaskReservation> FetchTaskReservation(string workspaceSid,
        string taskSid,
        string sid,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default8("/v1/Workspaces/{WorkspaceSid}/Tasks/{TaskSid}/Reservations/{Sid}"),
            [new TemplateParam("WorkspaceSid", workspaceSid),
                new TemplateParam("TaskSid", taskSid),
                new TemplateParam("Sid", sid)],
            [],
            [],
            HttpMethod.Get,
            EmptyBody.Instance,
            JsonResponse.Create<TaskrouterV1WorkspaceTaskTaskReservation>(),
    ...
    /// Tasks reserved for workers
    /// </summary>
    /// <param name="workspaceSid">The SID of the Workspace with the TaskReservation resources to read.</param>
    /// <param name="taskSid">The SID of the reserved Task resource with the TaskReservation resources to read.</param>
    /// <param name="reservationStatus">Returns the list of reservations for a task with a specified ReservationStatus.  Can be: <c>pending</c>, <c>accepted</c>, <c>rejected</c>, or <c>timeout</c>.</param>
    ...
    /// <param name="requestOptions">Per-request options, such as an overriding log level for this call</param>
    /// <param name="ct">Cancellation token</param>
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ListTaskReservationResponse"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task<ListTaskReservationResponse> ListTaskReservation(string workspaceSid,
        string taskSid,
        TaskReservationEnumStatus? reservationStatus,
        string? workerSid,
        long? pageSize,
        int? page,
        string? pageToken,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default8("/v1/Workspaces/{WorkspaceSid}/Tasks/{TaskSid}/Reservations"),
            [new TemplateParam("WorkspaceSid", workspaceSid), new TemplateParam("TaskSid", taskSid)],
            ...
            HttpMethod.Get,
            EmptyBody.Instance,
            JsonResponse.Create<ListTaskReservationResponse>(),
            RawErrorResponse.Instance,
            [_auth.AccountSidAuthToken],
            requestOptions,
            ct);
    ...
    /// Tasks reserved for workers
    /// </summary>
    /// <param name="workspaceSid">The SID of the Workspace with the TaskReservation resources to update.</param>
    /// <param name="taskSid">The SID of the reserved Task resource with the TaskReservation resources to update.</param>
    /// <param name="sid">The SID of the TaskReservation resource to update.</param>
    ...
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="TaskrouterV1WorkspaceTaskTaskReservation"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task<TaskrouterV1WorkspaceTaskTaskReservation> UpdateTaskReservation(string workspaceSid,
        string taskSid,
        string sid,
        string? ifMatch,
        TaskReservationEnumStatus? reservationStatus,
        ...
        IReadOnlyList<TaskReservationEnumConferenceEvent>? conferenceStatusCallbackEvent,
        ...
        TaskReservationEnumSupervisorMode? supervisorMode,
        string? supervisor,
        ...
        _rawClient.Execute(_server.Default8("/v1/Workspaces/{WorkspaceSid}/Tasks/{TaskSid}/Reservations/{Sid}"),
            ...
            FormUrlEncodedRequest.Create([new Param("ReservationStatus", reservationStatus),
                    ...
                    new Param("SupervisorMode", supervisorMode),
                    new Param("Supervisor", supervisor),
