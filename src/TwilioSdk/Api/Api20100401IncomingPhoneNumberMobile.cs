...
public sealed class Api20100401IncomingPhoneNumberMobile
{
    private readonly RawClient _rawClient;
    private readonly Server _server;
    private readonly AuthSchemes _auth;

    internal Api20100401IncomingPhoneNumberMobile(RawClient rawClient, Server server, AuthSchemes auth)
    {
    ...
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task<ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile> CreateIncomingPhoneNumberMobile(string accountSid,
        string phoneNumber,
        string? apiVersion,
        string? friendlyName,
        ...
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Mobile.json"),
            ...
            JsonResponse.Create<ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile>(),
    ...
    /// <param name="requestOptions">Per-request options, such as an overriding log level for this call</param>
    /// <param name="ct">Cancellation token</param>
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ListIncomingPhoneNumberMobileResponse"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task<ListIncomingPhoneNumberMobileResponse> ListIncomingPhoneNumberMobile(string accountSid,
        bool? beta,
        string? friendlyName,
        string? phoneNumber,
        string? origin,
        ...
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Mobile.json"),
            ...
            HttpMethod.Get,
            EmptyBody.Instance,
            JsonResponse.Create<ListIncomingPhoneNumberMobileResponse>(),
            RawErrorResponse.Instance,
            [_auth.AccountSidAuthToken],
            requestOptions,
            ct);
