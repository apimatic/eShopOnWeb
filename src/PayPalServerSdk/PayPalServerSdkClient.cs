...
///  - Orders Controller: <see href="https://developer.paypal.com/legacy/docs/api/orders/v2/">Orders API v2</see>
///  - Payments Controller: <see href="https://developer.paypal.com/legacy/docs/api/payments/v2">Payments API v2</see>
///  - Vault Controller: <see href="https://developer.paypal.com/legacy/docs/api/payment-tokens/v3/">Payment Method Tokens API v3</see> *Available in the US only.*
///  - Transaction Search Controller: <see href="https://developer.paypal.com/legacy/docs/api/transaction-search/v1/">Transaction Search API v1</see>
///  - Subscriptions Controller: <see href="https://developer.paypal.com/legacy/docs/api/subscriptions/v1/">Subscriptions API v1</see>
/// </summary>
public sealed class PayPalServerSdkClient
{
    ...
    public PayPalServerSdkClient(HttpClient httpClient, PayPalServerSdkClientOptions options)
    {
        ...
        var httpLogger = new HttpLogger(options.Logging, "PayPalServerSdkClient", options.TimeProvider);
