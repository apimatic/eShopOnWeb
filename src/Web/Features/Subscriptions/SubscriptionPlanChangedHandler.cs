...
public class SubscriptionPlanChangedHandler : INotificationHandler<SubscriptionPlanChanged>
{
    ...
    {
        _logger.LogInformation("Subscription {0} for user {1} changed plan from {2} to {3}",
            notification.SubscriptionId, notification.UserId, notification.OldProductHandle, notification.NewProductHandle);
