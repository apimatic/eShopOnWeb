...
// DTOs mirroring the Twilio OpenAPI schemas (api-specs/twilio). Property names map
// the provider's snake_case wire format.
...
{
    [JsonPropertyName("messages")] public List<TwilioMessage> Messages { get; set; } = new();
...
internal class TwilioErrorResponse
{
...
internal class TwilioLookupResponse
{
