...
/// <summary>
/// Binds the <c>PayPal:</c> configuration section. Values are supplied via configuration / user
/// secrets (never hard-coded), so the same build can run against a different PayPal account.
/// </summary>
public class PayPalSettings
{
    ...
    /// <summary>ISO-4217 currency all amounts are denominated in.</summary>
