...
{
    [JsonPropertyName("payment_source")]
    public PayPalTokenSource? PaymentSource { get; set; }
}

internal sealed class PayPalTokenSource
{
    [JsonPropertyName("token")]
    public PayPalTokenRef? Token { get; set; }
}
...
{
    [JsonPropertyName("card")]
    public PayPalVaultedCardSource? Card { get; set; }
}

internal sealed class PayPalVaultedCardSource
{
