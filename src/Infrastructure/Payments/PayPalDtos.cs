...
internal sealed class PayPalOrderRequestDto
{
...
internal sealed class PayPalAuthorizationDto
{
    ...
    public List<PayPalLinkDto>? Links { get; set; }
    public PayPalSupplementaryDataDto? SupplementaryData { get; set; }
}
...
internal sealed class PayPalSupplementaryDataDto
{
    public PayPalRelatedIdsDto? RelatedIds { get; set; }
}

internal sealed class PayPalRelatedIdsDto
{
