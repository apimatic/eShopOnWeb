        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxioCustomerId = table.Column<double>(type: "float", nullable: true),
                    MaxioSubscriptionId = table.Column<double>(type: "float", nullable: true),
                    ...
                    SubscriptionState = table.Column<string>(type: "nvarchar(max)", nullable: true),
