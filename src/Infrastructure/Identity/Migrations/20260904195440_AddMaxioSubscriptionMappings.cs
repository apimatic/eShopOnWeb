        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationStartedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaxioSubscriptionMappings_UserId_PlanHandle",
                table: "MaxioSubscriptionMappings",
