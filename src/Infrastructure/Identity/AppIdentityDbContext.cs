...
public class AppIdentityDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<MaxioCustomerMapping>(entity =>
        {
            ...
            entity.HasIndex(mapping => mapping.UserId).IsUnique();
            entity.HasIndex(mapping => mapping.MaxioCustomerId).IsUnique();
        });
        ...
        builder.Entity<MaxioSubscriptionMapping>(entity =>
        {
            ...
            entity.Property(mapping => mapping.State).HasMaxLength(64);
