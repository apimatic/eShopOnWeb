...
/// <summary>
/// HTTP Basic auth as declared by the Twilio OpenAPI <c>accountSid_authToken</c> security scheme.
/// </summary>
public sealed class TwilioBasicAuthHandler : DelegatingHandler
{
    private readonly IOptions<TwilioOptions> _options;

    public TwilioBasicAuthHandler(IOptions<TwilioOptions> options)
    {
        _options = options;
    }
