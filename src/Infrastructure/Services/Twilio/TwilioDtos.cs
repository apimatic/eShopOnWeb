...
/// <summary>
/// Wire models matching the Twilio OpenAPI response schemas we consume:
/// <c>api.v2010.account.message</c>, the Messages list envelope, the Lookups v2 phone-number
/// resource, and the shared Twilio error model. Field names follow the spec exactly.
/// </summary>
