...
public class PaymentMethodConfiguration : IEntityTypeConfiguration<PaymentMethod>
{
    public void Configure(EntityTypeBuilder<PaymentMethod> builder)
    {
        ...
        builder.Property(pm => pm.CardId).IsRequired().HasMaxLength(128);
        ...
        builder.Property(pm => pm.ExpiryMonth).HasMaxLength(2);
        builder.Property(pm => pm.ExpiryYear).HasMaxLength(4);
