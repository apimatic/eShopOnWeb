...
public class OrderConfiguration : IEntityTypeConfiguration<Order>
{
    public void Configure(EntityTypeBuilder<Order> builder)
    {
        ...
        builder.OwnsOne(o => o.Payment, payment =>
        {
            ...
            payment.Property(p => p.InvoiceId).HasMaxLength(100);
            payment.Property(p => p.CreateRequestId).HasMaxLength(100);
            payment.Property(p => p.AuthorizeRequestId).HasMaxLength(100);
            payment.Property(p => p.CaptureRequestId).HasMaxLength(100);
            payment.Property(p => p.VoidRequestId).HasMaxLength(100);
        ...
        builder.OwnsMany(o => o.Refunds, refund =>
        {
            ...
            refund.Property(r => r.Id).ValueGeneratedOnAdd();
            ...
            refund.Property(r => r.TotalRefundedAmount).HasColumnType("decimal(18,2)");
        });
