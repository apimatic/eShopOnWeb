...
public class OrderConfiguration : IEntityTypeConfiguration<Order>
{
    public void Configure(EntityTypeBuilder<Order> builder)
    {
        ...
        builder.Property(o => o.PayRequestId).HasMaxLength(128);
        builder.Property(o => o.FulfilRequestId).HasMaxLength(128);
        builder.Property(o => o.CancelRequestId).HasMaxLength(128);
