...
public class OrderConfiguration : IEntityTypeConfiguration<Order>
{
    public void Configure(EntityTypeBuilder<Order> builder)
    {
        ...
        builder.Property(o => o.LastPaymentError).HasMaxLength(1024);
        builder.Property(o => o.PayAuthorizeRequestId).HasMaxLength(128);
        builder.Property(o => o.PayCaptureRequestId).HasMaxLength(128);
        builder.Property(o => o.PayVoidRequestId).HasMaxLength(128);
