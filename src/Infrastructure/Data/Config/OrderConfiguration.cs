...
public class OrderConfiguration : IEntityTypeConfiguration<Order>
{
    public void Configure(EntityTypeBuilder<Order> builder)
    {
        ...
        builder.Property(o => o.PayIdempotencyKey).HasMaxLength(64);
        builder.Property(o => o.CaptureIdempotencyKey).HasMaxLength(64);
        builder.Property(o => o.CancelIdempotencyKey).HasMaxLength(64);
