...
public class OrderConfiguration : IEntityTypeConfiguration<Order>
{
    public void Configure(EntityTypeBuilder<Order> builder)
    {
        ...
        // The payment is part of the Order aggregate: owned by the order, with its refunds owned in turn.
        builder.OwnsOne(o => o.Payment, p =>
        {
            p.WithOwner();

            p.Property(x => x.ReferenceId).HasMaxLength(64).IsRequired();
            ...
            p.Property(x => x.AuthorizationStatus).HasMaxLength(32).IsRequired();
