...
public class OrderNotificationConfiguration : IEntityTypeConfiguration<OrderNotification>
{
    public void Configure(EntityTypeBuilder<OrderNotification> builder)
    {
        ...
        builder.Property(n => n.ForOrderId).IsRequired();
        builder.Property(n => n.DestinationContactId);

        builder.HasIndex(n => n.ForOrderId);
        builder.HasIndex(n => n.ProviderMessageSid);
        builder.HasIndex(n => new { n.ResentFromNotificationId, n.ResendIdempotencyKey });
    }
}
