...
public class OrderNotificationConfiguration : IEntityTypeConfiguration<OrderNotification>
{
    public void Configure(EntityTypeBuilder<OrderNotification> builder)
    {
        ...
        // The claim that prevents a duplicate resend under a repeated idempotency key. On SQL Server this
        // filtered unique index rejects the second insert; the resend service catches that rejection.
        // (The dev in-memory provider does not enforce indexes — see the service's supplementary check.)
