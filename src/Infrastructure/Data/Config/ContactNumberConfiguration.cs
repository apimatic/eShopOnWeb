...
public class ContactNumberConfiguration : IEntityTypeConfiguration<ContactNumber>
{
    public void Configure(EntityTypeBuilder<ContactNumber> builder)
    {
        ...
        builder.Property(c => c.E164Number).IsRequired().HasMaxLength(32);

        // A shopper cannot register the same number twice.
        builder.HasIndex(c => new { c.OwnerId, c.E164Number }).IsUnique();
    }
}
