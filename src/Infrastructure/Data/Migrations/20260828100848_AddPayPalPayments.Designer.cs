...
namespace Microsoft.eShopWeb.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260828100848_AddPayPalPayments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.PaymentAggregate.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AuthorizationGeneration")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTimeOffset?>("CaptureCreatedAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<decimal?>("MerchantNet")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("ReauthorizeRequestId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.PaymentAggregate.SavedPaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OwnerId", "PayPalTokenId")
                        .IsUnique()
                        .HasFilter("[PayPalTokenId] IS NOT NULL");
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.PaymentAggregate.PaymentRefund", b =>
                {
                    b.HasOne("Microsoft.eShopWeb.ApplicationCore.Entities.PaymentAggregate.PaymentRecord", null)
                        .WithMany("Refunds")
