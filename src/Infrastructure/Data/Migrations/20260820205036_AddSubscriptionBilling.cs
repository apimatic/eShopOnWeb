        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionUniquenessToken = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ...
                    SynchronizedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionRecords_CustomerReference",
