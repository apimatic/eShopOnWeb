...
{
    /// <inheritdoc />
    public partial class AddPaymentsAndVault : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentSourceDescription = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentRefund_OrderPayments_OrderPaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRefund_OrderPaymentId",
                table: "PaymentRefund",
