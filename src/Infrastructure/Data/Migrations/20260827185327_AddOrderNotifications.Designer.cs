...
namespace Microsoft.eShopWeb.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260827185327_AddOrderNotifications")]
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.NotificationAggregate.OrderNotification", b =>
                {
                    ...
                    b.Property<int?>("CancellationErrorCode")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProviderSid")
                        .IsUnique()
                        .HasFilter("[ProviderSid] IS NOT NULL");

                    b.HasIndex("OriginalNotificationId", "ResendIdempotencyKey")
                        .IsUnique()
