...
namespace Microsoft.eShopWeb.Infrastructure.Data.Migrations
{
    ...
    public partial class AddPayPalPayments : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("UPDATE [Orders] SET [ExternalId] = NEWID() WHERE [ExternalId] IS NULL");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorizationLastRenewedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
