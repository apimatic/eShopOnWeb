        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceInDollars = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IntervalUnit = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentPriceInDollars = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPlans_Handle",
                table: "SubscriptionPlans",
                column: "Handle",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPlans_MaxioProductId",
                table: "SubscriptionPlans",
                column: "MaxioProductId",
                unique: true);
