...
namespace Microsoft.eShopWeb.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260828113543_AddPayPalPayments")]
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.BuyerAggregate.SavedPaymentMethod", b =>
                {
                    ...
                    b.Property<string>("MerchantCustomerId")
                        .IsRequired()
                        .HasMaxLength(64)
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.OrderAggregate.Order", b =>
                {
                    ...
                    b.Property<string>("PaymentCorrelationId")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");
                    ...
                    b.HasIndex("AuthorizationId")
                        .IsUnique()
                        .HasFilter("[AuthorizationId] IS NOT NULL");
