...
namespace Microsoft.eShopWeb.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260823212245_AddMaxioSubscriptionBilling")]
    partial class AddMaxioSubscriptionBilling
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Subscriptions.MaxioCustomerMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MaxioCustomerId")
                        .IsUnique()
                        .HasFilter("[MaxioCustomerId] IS NOT NULL");
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Subscriptions.RecurringSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MaxioSubscriptionReference")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("MaxioSubscriptionReference")
                        .IsUnique();

                    b.HasIndex("ApplicationUserId", "ProductHandle")
                        .IsUnique();

                    b.ToTable("RecurringSubscriptions", (string)null);
                });
