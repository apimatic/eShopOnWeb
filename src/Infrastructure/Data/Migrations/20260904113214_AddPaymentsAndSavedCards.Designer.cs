...
namespace Microsoft.eShopWeb.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260904113214_AddPaymentsAndSavedCards")]
    partial class AddPaymentsAndSavedCards
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.PaymentMethodAggregate.SavedPaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("VaultCustomerId")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<string>("VaultTokenId")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.OrderAggregate.Order", b =>
                {
                    ...
                    b.OwnsOne("Microsoft.eShopWeb.ApplicationCore.Entities.OrderAggregate.PaymentDetails", "Payment", b1 =>
                        {
                            b1.Property<int>("OrderId")
                                .HasColumnType("int");

                            b1.Property<DateTimeOffset?>("AuthorizationCreatedTime")
                                .HasColumnType("datetimeoffset");

                            b1.Property<DateTimeOffset?>("AuthorizationExpirationTime")
                                .HasColumnType("datetimeoffset");
                            ...
                            b1.Property<string>("AuthorizationStatus")
                                .IsRequired()
                                .HasMaxLength(32)
                                .HasColumnType("nvarchar(32)");

                            b1.Property<decimal>("AuthorizedAmount")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)");
                            ...
                            b1.Property<string>("CaptureStatus")
                                .IsRequired()
                                .HasMaxLength(32)
                                .HasColumnType("nvarchar(32)");
                            ...
                            b1.Property<string>("InvoiceReference")
                                .IsRequired()
                                .HasMaxLength(128)
                                .HasColumnType("nvarchar(128)");
                            ...
                            b1.Property<string>("NetworkTransactionReference")
                                .IsRequired()
                                .HasMaxLength(128)
                                .HasColumnType("nvarchar(128)");
                            ...
                            b1.Property<string>("ProviderOrderId")
                                .IsRequired()
                                .HasMaxLength(64)
                                .HasColumnType("nvarchar(64)");

                            b1.Property<string>("UsedVaultTokenId")
                                .IsRequired()
                                .HasMaxLength(64)
                                .HasColumnType("nvarchar(64)");
                            ...
                            b1.ToTable("OrderPayments", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("OrderId");
                        });

                    b.OwnsMany("Microsoft.eShopWeb.ApplicationCore.Entities.OrderAggregate.PaymentRefund", "Refunds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.Property<string>("ProviderCaptureId")
                                .IsRequired()
                                .HasMaxLength(64)
                                .HasColumnType("nvarchar(64)");

                            b1.Property<string>("ProviderRefundId")
                                .IsRequired()
                                .HasMaxLength(64)
                                .HasColumnType("nvarchar(64)");

                            b1.Property<string>("RefundReference")
                                .IsRequired()
                                .HasMaxLength(160)
                            ...
                            b1.Property<decimal?>("TotalRefundedAmount")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)");
                            ...
                            b1.ToTable("OrderPaymentRefunds", (string)null);
