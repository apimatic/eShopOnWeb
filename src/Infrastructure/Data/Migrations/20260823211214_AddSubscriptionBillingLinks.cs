...
{
    /// <inheritdoc />
    public partial class AddSubscriptionBillingLinks : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "SubscriptionBillingLinks",
                columns: table => new
                {
                    ...
                    LeaseToken = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionBillingLinks", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionBillingLinks_SubscriptionReference",
                table: "SubscriptionBillingLinks",
                column: "SubscriptionReference",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionBillingLinks_UserId_ProductHandle",
                table: "SubscriptionBillingLinks",
