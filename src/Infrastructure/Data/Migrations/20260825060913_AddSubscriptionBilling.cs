    ...
    public partial class AddSubscriptionBilling : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionReservations", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionReservations_CustomerReference",
                table: "SubscriptionReservations",
                column: "CustomerReference");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionReservations_SubscriptionReference",
                table: "SubscriptionReservations",
                column: "SubscriptionReference",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionReservations_UserId_ProductHandle",
                table: "SubscriptionReservations",
