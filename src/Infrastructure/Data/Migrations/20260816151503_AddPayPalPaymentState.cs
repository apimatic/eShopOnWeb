...
{
    /// <inheritdoc />
    public partial class AddPayPalPaymentState : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderRefund", x => new { x.OrderId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayPalVaultId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    PayPalCustomerId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
