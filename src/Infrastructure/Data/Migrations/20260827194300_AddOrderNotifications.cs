...
namespace Microsoft.eShopWeb.Infrastructure.Data.Migrations
{
    ...
    public partial class AddOrderNotifications : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderNotifications_ResendsNotificationId_IdempotencyKey",
                table: "OrderNotifications",
                columns: new[] { "ResendsNotificationId", "IdempotencyKey" },
                unique: true,
                filter: "[ResendsNotificationId] IS NOT NULL AND [IdempotencyKey] IS NOT NULL");
        }
