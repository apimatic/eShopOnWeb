        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentRedactedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationResendRequests_OrderNotifications_ResultNotificationId",
                        column: x => x.ResultNotificationId,
                        principalTable: "OrderNotifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NotificationResendRequests_OrderNotifications_SourceNotificationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationResendRequests_ResultNotificationId",
                table: "NotificationResendRequests",
                column: "ResultNotificationId");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationResendRequests_SourceNotificationId_IdempotencyKey",
                table: "NotificationResendRequests",
