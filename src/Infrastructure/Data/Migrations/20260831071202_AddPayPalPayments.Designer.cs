...
namespace Microsoft.eShopWeb.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260831071202_AddPayPalPayments")]
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.BuyerAggregate.PaymentMethod", b =>
                {
                    ...
                    b.HasIndex("BuyerId", "PayPalVaultId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.OrderAggregate.Order", b =>
                {
                    ...
                    b.OwnsOne("Microsoft.eShopWeb.ApplicationCore.Entities.OrderAggregate.OrderPayment", "Payment", b1 =>
                        {
                            b1.Property<int>("OrderId")
                                .HasColumnType("int");

                            b1.Property<DateTimeOffset?>("AuthorizationExpiresAt")
                                .HasColumnType("datetimeoffset");

                            b1.Property<DateTimeOffset>("AuthorizationHonorExpiresAt")
                                .HasColumnType("datetimeoffset");
                            ...
                            b1.Property<DateTimeOffset>("AuthorizedAt")
                                .HasColumnType("datetimeoffset");
                            ...
                            b1.Property<DateTimeOffset>("OriginalAuthorizedAt")
                                .HasColumnType("datetimeoffset");

                            b1.Property<decimal?>("PayPalFee")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)");

                            b1.Property<string>("PayPalOrderId")
                                .IsRequired()
                                .HasMaxLength(64)
                                .HasColumnType("nvarchar(64)");

                            b1.Property<int>("ReauthorizationCount")
                                .HasColumnType("int");
                            ...
                            b1.OwnsMany("Microsoft.eShopWeb.ApplicationCore.Entities.OrderAggregate.PaymentRefund", "Refunds", b2 =>
                                {
                                    b2.Property<int>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("int");
                                    ...
                                    b2.Property<string>("IdempotencyKey")
                                        .IsRequired()
                                        .HasMaxLength(108)
                                    ...
                                    b2.Property<string>("PayPalRefundId")
                                        .IsRequired()
                                        .HasMaxLength(64)
                                        .HasColumnType("nvarchar(64)");
                                    ...
                                    b2.HasIndex("OrderId", "IdempotencyKey")
                                        .IsUnique();

                                    b2.ToTable("PaymentRefunds", (string)null);

                                    b2.WithOwner()
                                        .HasForeignKey("OrderId");
                                });

                            b1.Navigation("Refunds");
                        });
