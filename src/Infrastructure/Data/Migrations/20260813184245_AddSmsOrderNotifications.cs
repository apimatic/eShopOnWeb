    ...
    public partial class AddSmsOrderNotifications : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddColumn<string>(
                ...
                maxLength: 20,
                nullable: false,
                // Existing orders predate the notification feature; treat them as placed.
                defaultValue: "Placed");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocalError = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_ProviderMessageSid",
                table: "Notifications",
                column: "ProviderMessageSid");

            migrationBuilder.CreateIndex(
                name: "IX_ResendIdempotencyRecords_IdempotencyKey",
