...
public sealed class MySubscriptionsEndpoint : IEndpoint<IResult>
{
    ...
    {
        app.MapGet("api/my-subscriptions", HandleRouteAsync)
    ...
    private async Task<IResult> HandleRouteAsync(HttpContext httpContext, CancellationToken cancellationToken)
    {
