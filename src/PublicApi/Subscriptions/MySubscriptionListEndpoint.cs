...
public sealed class MySubscriptionListEndpoint : IEndpoint<IResult, HttpContext, SubscriptionService>
{
    ...
    {
        var items = await subscriptions.ListMySubscriptionsAsync(context.User, context.RequestAborted);
