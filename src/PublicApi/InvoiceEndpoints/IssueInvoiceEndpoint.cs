...
/// <summary>
/// Puts a bill to the shopper (operator action). Afterwards the application can hand out a way to
/// pay it and the bill reports itself as having been put to them.
/// </summary>
