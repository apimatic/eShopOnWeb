...
// Wire DTOs for the Maxio Advanced Billing HTTP API (snake_case JSON). Only the fields the
// integration reads are declared; unknown fields are ignored by System.Text.Json.
...
internal sealed class MaxioSubscriptionCustomerDto
{
    [JsonPropertyName("id")]
    public long Id { get; set; }
...
{
    [JsonPropertyName("customer")]
    public MaxioCreateCustomerDto? Customer { get; set; }
}

internal sealed class MaxioCreateCustomerDto
{
    [JsonPropertyName("first_name")]
    public string? FirstName { get; set; }
...
{
    [JsonPropertyName("subscription")]
    public MaxioCreateSubscriptionDto? Subscription { get; set; }
}

internal sealed class MaxioCreateSubscriptionDto
{
