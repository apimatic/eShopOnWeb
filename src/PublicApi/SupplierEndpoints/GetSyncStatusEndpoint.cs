...
/// <summary>
/// Returns the status and outcome of a single sync (whether it is still running, captured the
/// whole listing, or only part of it, plus how many products it found versus imported). Operator-only.
/// </summary>
