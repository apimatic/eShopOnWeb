...
public class StartSupplierSyncResponse : BaseResponse
{
    ...
    /// <summary>The id of the started sync; poll it at GET api/catalog/syncs/{syncId}.</summary>
    public int SyncId { get; set; }

    public int SupplierId { get; set; }

    /// <summary>The sync's status at creation time (typically "Pending").</summary>
