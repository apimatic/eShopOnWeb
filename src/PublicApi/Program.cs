...
// Bind settings from the PayPal: section (values live in user-secrets / env, never in the repo).
...
// Typed HttpClient whose base address is the resolved PayPal environment (or the BaseUrl override).
