...
// SMS order-notification integration (Twilio). Settings are bound from the "Twilio:" configuration
// section; the messaging provider is a typed HttpClient so BaseUrl and credentials come from config.
