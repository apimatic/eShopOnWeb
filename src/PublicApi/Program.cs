...
// Settings bind from the "Twilio:" section (values supplied via user-secrets / environment; never
// hard-coded). The SMS provider is built by hand against the Twilio OpenAPI spec — no third-party SDK.
