...
builder.Services.AddScoped<IPayPalSettings>(sp => sp.GetRequiredService<Microsoft.Extensions.Options.IOptions<PayPalOptions>>().Value);
...
static void Map(Dictionary<string, string?> overlay, string environmentVariable, string configurationKey)
{
