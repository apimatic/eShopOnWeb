...
builder.Services.AddScoped<IOrderSmsNotificationService, OrderSmsNotificationService>();
...
ApplyTwilioEnvironmentOverlay(builder.Configuration);
...
{
    private static void ApplyTwilioEnvironmentOverlay(ConfigurationManager configuration)
    {
