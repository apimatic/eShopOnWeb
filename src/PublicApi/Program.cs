...
// Settings are bound from the "Maxio" configuration section (see MaxioOptions). Secret
// values (ApiKey, ...) are supplied through .NET user-secrets or environment configuration,
