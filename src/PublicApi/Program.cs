...
MaxioConfiguration.ApplyEnvironmentOverrides(builder.Configuration);
...
{
    MaxioAdvancedBillingClient.ConfigureHttpClient(client, sp.GetRequiredService<MaxioOptions>());
});
