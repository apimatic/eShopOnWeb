...
BindPayPalConfiguration(builder.Configuration);
builder.Services.Configure<PayPalOptions>(builder.Configuration.GetSection(PayPalOptions.SectionName));
builder.Services.AddSingleton<IPayPalSettings, PayPalSettings>();
...
static void BindPayPalConfiguration(ConfigurationManager configuration)
{
