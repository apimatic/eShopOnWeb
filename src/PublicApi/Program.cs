...
builder.Services.AddHttpClient(TwilioLookupClient.HttpClientName, client =>
{
    client.BaseAddress = new Uri("https://lookups.twilio.com/");
});
builder.Services.AddHttpClient(TwilioMessagingClient.HttpClientName);
builder.Services.AddScoped<IPhoneNumberLookup, TwilioLookupClient>();
builder.Services.AddScoped<IOrderSmsGateway, TwilioMessagingClient>();
...
static void BindTwilioFromEnvironment(Microsoft.Extensions.Configuration.ConfigurationManager configuration)
{
