...
builder.Services.AddHttpClient<ITwilioMessagingClient, TwilioMessagingClient>((_, client) =>
{
    var baseUrl = string.IsNullOrWhiteSpace(twilioSettings.BaseUrl) ? "https://api.twilio.com" : twilioSettings.BaseUrl.Trim();
    if (!baseUrl.EndsWith('/'))
    {
        baseUrl += "/";
    }
...
public partial class Program
{
    private static void BindTwilioEnvironmentVariables(ConfigurationManager configuration)
    {
        ...
        void Copy(string environmentName, string configurationKey)
        {
