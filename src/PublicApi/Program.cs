...
builder.Configuration.AddInMemoryCollection(
    maxioEnvironmentSettings.Where(entry => !string.IsNullOrWhiteSpace(entry.Value))!);
...
Microsoft.eShopWeb.Infrastructure.Dependencies.ConfigureMaxioBilling(builder.Configuration, builder.Services);
