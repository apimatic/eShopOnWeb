...
// SMS order notifications (Twilio). Settings are validated on start; a missing credential
// refuses boot rather than surfacing as a provider error on the first request.
