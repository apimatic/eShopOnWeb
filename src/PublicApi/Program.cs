...
builder.Services.AddScoped<IUnitOfWork>(sp => sp.GetRequiredService<CatalogContext>());
...
builder.Services.AddHttpClient(TwilioSmsGateway.MessagingClientName, client =>
{
    client.Timeout = TimeSpan.FromSeconds(30);
});
builder.Services.AddHttpClient(TwilioSmsGateway.LookupClientName, client =>
{
    client.Timeout = TimeSpan.FromSeconds(30);
});
