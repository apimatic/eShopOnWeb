...
// PayPal payments integration: bind the PayPal: settings, register the API client (typed HttpClient),
...
builder.Services.AddSingleton<IPaymentConfiguration, PaymentConfiguration>();
