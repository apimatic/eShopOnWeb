...
// PayPal payment integration: bind PayPal:* settings, wire the typed HTTP client and the
// application services for orders/payments, saved cards and reconciliation.
