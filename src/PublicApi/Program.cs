...
builder.Services.AddHttpClient<IMaxioService, MaxioService>((sp, client) =>
{
    ...
    var basicAuthToken = Convert.ToBase64String(Encoding.ASCII.GetBytes($"{maxioOptions.ApiKey}:x"));
