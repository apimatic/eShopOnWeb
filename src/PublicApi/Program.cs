...
// PayPal integration: settings bound from the PayPal: section (values come from user-secrets/config, never
// hard-coded), the REST client, and the payment/saved-card/reconciliation application services.
