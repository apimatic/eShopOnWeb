...
builder.Services.AddScoped<IOrderMessagingService, OrderMessagingService>();
builder.Services.Configure<TwilioSettings>(builder.Configuration.GetSection(TwilioSettings.SectionName));
builder.Services.AddHttpClient<ISmsProvider, TwilioSmsProvider>(client =>
{
...
static void ApplyTwilioEnvironmentVariables(IConfigurationBuilder configuration)
{
