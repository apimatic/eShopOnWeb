...
builder.Services.AddHttpClient<ITwilioSmsClient, TwilioSmsClient>(client =>
{
...
{
    private static void BindTwilioFromEnvironment(Microsoft.Extensions.Configuration.ConfigurationManager configuration)
    {
