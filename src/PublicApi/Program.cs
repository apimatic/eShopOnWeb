...
using System.Text;using BlazorShared;
...
// Values come from the "Maxio" configuration section, loaded from user-secrets.
// Validation is deferred to first use so that test hosts without a Maxio
// configuration can still boot the app.
