...
builder.Services.AddScoped<ITwilioApiClient, TwilioApiClient>();

builder.Services.Configure<TwilioSettings>(builder.Configuration.GetSection(TwilioSettings.SectionName));
builder.Services.AddHttpClient(TwilioApiClient.MessagingClientName);
builder.Services.AddHttpClient(TwilioApiClient.LookupClientName);
builder.Logging.AddFilter("System.Net.Http.HttpClient.TwilioMessaging", LogLevel.Warning);
builder.Logging.AddFilter("System.Net.Http.HttpClient.TwilioLookup", LogLevel.Warning);
...
BindTwilioSettingsFromEnvironment(builder.Configuration);
...
static void BindTwilioSettingsFromEnvironment(ConfigurationManager configuration)
{
