...
// PayPal integration: settings (bound from the PayPal: section), the hand-written PayPal client, and
// the application services that orchestrate the payment / saved-card flows.
