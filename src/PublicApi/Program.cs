...
// SMS order notifications (Twilio). Settings are bound from the "Twilio" configuration section only;
// no values are hard-coded. The auth token lives in configuration/user-secrets and is never logged.
