...
// SMS order-notification integration (Twilio, built against api-specs).
...
builder.Services.AddScoped<IContactNumberService, Microsoft.eShopWeb.ApplicationCore.Services.ContactNumberService>();
