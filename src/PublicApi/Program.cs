...
{
    private static void MapMaxioEnvironmentVariables(ConfigurationManager configuration)
    {
        ...
        {
            var value = configuration[environmentName] ?? Environment.GetEnvironmentVariable(environmentName);
