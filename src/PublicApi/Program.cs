...
BindTwilioFromEnvironment(builder.Configuration);
builder.Services.Configure<TwilioSettings>(builder.Configuration.GetSection(TwilioSettings.SectionName));
builder.Services.AddHttpClient<TwilioApiClient>();
builder.Services.AddTransient<ITwilioLookupClient>(sp => sp.GetRequiredService<TwilioApiClient>());
builder.Services.AddTransient<ITwilioMessagingClient>(sp => sp.GetRequiredService<TwilioApiClient>());
builder.Logging.AddFilter("System.Net.Http.HttpClient.TwilioApiClient", LogLevel.None);
...
static void BindTwilioFromEnvironment(IConfiguration configuration)
{
