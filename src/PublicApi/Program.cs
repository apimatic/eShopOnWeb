...
builder.Services.AddSingleton<ITwilioClient>(serviceProvider =>
{
    ...
    return new TwilioClient(httpClient,
        serviceProvider.GetRequiredService<Microsoft.Extensions.Options.IOptions<TwilioSettings>>());
});
