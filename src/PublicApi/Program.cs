...
// Settings come from the "Maxio" configuration section; the API key must be supplied out of band
// (user-secrets in development, environment variables or a vault elsewhere).
