...
builder.Services.AddHttpClient<IMaxioSubscriptionService, MaxioSubscriptionService>((sp, client) =>
{
    ...
    // Maxio Advanced Billing uses HTTP Basic auth: the site API key as the username, "x" as
