...
builder.Services.AddHttpClient<ITwilioLookupClient, TwilioLookupClient>().RemoveAllLoggers();
...
static void BindTwilioFromEnvironment(ConfigurationManager configuration)
{
