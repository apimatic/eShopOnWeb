...
// Registration never throws on missing credentials: the rest of the API must still start,
// and the subscription endpoints report the misconfiguration instead.
