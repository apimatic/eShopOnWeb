...
public class DeletePaymentMethodEndpoint : IEndpoint<IResult, DeletePaymentMethodRequest, ISavedCardService>
{
    ...
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapDelete("api/payment-methods/{paymentMethodId}",
            ...
            ([FromRoute] int paymentMethodId, ISavedCardService savedCardService) =>
            {
                return await HandleAsync(new DeletePaymentMethodRequest { PaymentMethodId = paymentMethodId }, savedCardService);
            })
    ...
    public async Task<IResult> HandleAsync(DeletePaymentMethodRequest request, ISavedCardService savedCardService)
    {
        ...
        var deleted = await savedCardService.DeleteSavedCardAsync(buyerId, request.PaymentMethodId);
