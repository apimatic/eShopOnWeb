...
public class ExceptionMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        context.Response.StatusCode = exception switch
        {
            ...
            CatalogItemNotFoundException => (int)HttpStatusCode.NotFound,
            ...
            IdempotencyConflictException => (int)HttpStatusCode.Conflict,
            PayPalActionRequiredException => (int)HttpStatusCode.BadGateway,
            PayPalOperationException => (int)HttpStatusCode.BadGateway,
