...
public class ExceptionMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        {
            // The billing adapter has already decided what the caller should see and has logged the provider
            // detail; its message is caller-safe by construction.
            _logger.LogWarning(
                "Billing request failed with status {StatusCode}: {Message}",
                billingException.StatusCode,
