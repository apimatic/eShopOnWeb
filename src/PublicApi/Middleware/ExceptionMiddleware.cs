...
public class ExceptionMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        context.Response.StatusCode = exception switch
        {
            ...
            InvalidSubscriptionTransitionException => (int)HttpStatusCode.Conflict,
            PlanChangeException => (int)HttpStatusCode.Conflict,
            MeteredComponentMisconfiguredException => (int)HttpStatusCode.ServiceUnavailable,
