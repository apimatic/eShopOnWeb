...
public class ExceptionMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        var (statusCode, message) = exception switch
        {
            ...
            // The provider could not dispose of the content; report a gateway failure, not a false success.
            NotificationContentDisposalException => (HttpStatusCode.BadGateway, exception.Message),
