...
public class ExceptionMiddleware
{
    ...
    private static HttpStatusCode StatusCodeFor(Exception exception) => exception switch
    {
        ...
        SubscriptionNotActiveException => HttpStatusCode.Conflict,
        InvalidUsageQuantityException => HttpStatusCode.BadRequest,
        PlanChangeNotSupportedException => HttpStatusCode.BadRequest,
