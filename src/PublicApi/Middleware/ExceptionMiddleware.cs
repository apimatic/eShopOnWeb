...
public class ExceptionMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        {
            // Surface Maxio's own status code where it maps onto a client error; anything
            // else (unexpected upstream failures) is reported as a 502 Bad Gateway.
            ...
            {
                StatusCode = context.Response.StatusCode,
                Message = string.Join(" | ", maxioApiException.Errors)
            }.ToString());
        }
        else
        {
