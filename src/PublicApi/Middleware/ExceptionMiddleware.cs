...
public class ExceptionMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        var statusCode = exception switch
        {
            ...
            // A stale hold that can no longer be renewed is an operator-actionable conflict.
            AuthorizationNotRenewableException => HttpStatusCode.Conflict,
            // Any other failure reported by PayPal: we reached the provider but it rejected us.
