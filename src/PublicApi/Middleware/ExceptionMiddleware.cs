...
public class ExceptionMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        {
            // The billing provider was reachable but rejected the request (e.g. bad data) or is
            // misconfigured/unreachable. Either way this is an upstream problem, not ours.
