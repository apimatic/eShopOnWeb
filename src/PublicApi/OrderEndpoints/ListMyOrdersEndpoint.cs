...
public class ListMyOrdersEndpoint : IEndpoint<IResult, ClaimsPrincipal>
{
    ...
    public ListMyOrdersEndpoint(IRepository<Order> orderRepository, INotificationService notificationService)
    {
    ...
    public async Task<IResult> HandleAsync(ClaimsPrincipal user)
    {
        ...
        {
            var notifications = await _notificationService.GetOrderNotificationsAsync(order.Id, refreshStatus: true);
