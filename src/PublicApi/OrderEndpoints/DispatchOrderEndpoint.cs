...
public class DispatchOrderEndpoint : IEndpoint<IResult, int, IOrderNotificationWorkflow>
{
    ...
    {
        var result = await workflow.DispatchAsync(orderId);
...
public class OrderLifecycleResponse
{
