...
/// <summary>
/// POST /api/orders/{orderId}/dispatch — operator action. Marks the order dispatched, tells the
/// shopper it is on its way, and queues the "how did delivery go?" follow-up with the provider.
/// </summary>
