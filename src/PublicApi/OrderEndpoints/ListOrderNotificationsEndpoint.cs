...
public class ListOrderNotificationsEndpoint : IEndpoint<IResult, ListOrderNotificationsRequest, IShopperOrderService>
{
    ...
    private async Task<IResult> HandleAsync(ListOrderNotificationsRequest request, HttpContext httpContext, IShopperOrderService service)
    {
        ...
        var notifications = await service.ListNotificationsAsync(buyerId, request.OrderId, httpContext.RequestAborted);
