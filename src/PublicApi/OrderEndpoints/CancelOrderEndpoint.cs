...
/// <summary>
/// Operator action: cancels an order. Any delivery follow-up still queued with the provider
/// is called off so it never reaches the shopper, who is then notified of the cancellation.
/// </summary>
