...
/// follow-up still scheduled with the provider is called off so it never goes out.
/// </summary>
public class CancelOrderEndpoint : IEndpoint<IResult, int>
{
    ...
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapPost("api/orders/{orderId}/cancel",
            ...
            .Produces<OrderStatusUpdateResponse>()
    ...
    public async Task<IResult> HandleAsync(int orderId)
    {
        ...
        return Results.Ok(new OrderStatusUpdateResponse
        {
            OrderId = order.Id,
