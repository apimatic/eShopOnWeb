...
public class MyOrdersResponse : BaseResponse
{
    ...
    public IReadOnlyList<OrderPaymentView> Orders { get; set; } = Array.Empty<OrderPaymentView>();
}
...
public class MyOrdersEndpoint : IEndpoint<IResult, MyOrdersRequest, IOrderPaymentService>
{
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapGet("api/my-orders",
            ...
            {
                return await HandleAsync(new MyOrdersRequest { BuyerId = PaymentRequestMapper.GetBuyerId(user) }, service);
            })
