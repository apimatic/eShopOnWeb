...
/// <summary>Lists the signed-in shopper's own orders, with their current payment state.</summary>
public class MyOrdersEndpoint : IEndpoint<IResult, ClaimsPrincipal, IRepository<Order>>
{
