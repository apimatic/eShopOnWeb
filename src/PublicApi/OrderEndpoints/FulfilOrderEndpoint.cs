...
public class FulfilOrderEndpoint : IEndpoint<IResult, OrderIdRequest, IOrderPaymentService>
{
    ...
    public FulfilOrderEndpoint(IHttpContextAccessor httpContextAccessor, IPaymentSettings paymentSettings)
    {
    ...
    {
        var order = await paymentService.FulfilAsync(request.OrderId, _httpContextAccessor.HttpContext!.RequestAborted);
