...
public class FulfilOrderEndpoint : IEndpoint<IResult, OrderIdRequest, ICheckoutService>
{
    ...
    {
        var order = await checkoutService.FulfilAsync(request.OrderId, _httpContextAccessor.HttpContext!.RequestAborted);
