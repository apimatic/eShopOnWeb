...
/// <summary>
/// Operator action: marks the order fulfilled and captures the held funds. Renews a
/// stale authorization first; fails in operator-actionable terms when the hold can no
/// longer be renewed.
/// </summary>
