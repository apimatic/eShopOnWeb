...
// ---------------------------------------------------------------------------
// JSON contracts for the Maxio Advanced Billing REST API (documented at
// https://developers.maxio.com and generated for the official Maxio SDKs).
// Field names below mirror the snake_case payloads returned/sent by the API.
// ---------------------------------------------------------------------------
...
/// <summary>A Maxio product ("plan") as returned by the products endpoints.</summary>
public sealed class MaxioProductDto
{
    ...
    [JsonPropertyName("default_product_price_point_id")] public long? DefaultProductPricePointId { get; set; }
    [JsonPropertyName("product_price_point_id")] public long? ProductPricePointId { get; set; }
...
{
    [JsonPropertyName("subscription")] public MaxioSubscriptionDto? Subscription { get; set; }
}

public sealed class MaxioSiteDto
{
    [JsonPropertyName("id")] public long Id { get; set; }
...
{
    [JsonPropertyName("site")] public MaxioSiteDto? Site { get; set; }
}
...
{
    public MaxioCreateCustomerRequest(MaxioCustomerUpsert customer) => Customer = customer;

    [JsonPropertyName("customer")]
    public MaxioCustomerUpsert Customer { get; }
}

public sealed class MaxioCustomerUpsert
{
    [JsonPropertyName("first_name")] public string? FirstName { get; set; }
    [JsonPropertyName("last_name")] public string? LastName { get; set; }
    [JsonPropertyName("email")] public string? Email { get; set; }
...
{
    public MaxioCreateSubscriptionRequest(MaxioSubscriptionUpsert subscription) => Subscription = subscription;

    [JsonPropertyName("subscription")]
    public MaxioSubscriptionUpsert Subscription { get; }
}

public sealed class MaxioSubscriptionUpsert
{
