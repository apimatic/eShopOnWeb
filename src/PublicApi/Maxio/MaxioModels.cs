...
/// <summary>
/// Minimal, strongly-typed views over the Maxio (Advanced Billing) API JSON payloads.
/// Only the fields this integration needs are modeled; unknown fields are ignored.
/// </summary>
...
{
    [JsonPropertyName("customer")]
    public MaxioNewCustomer? Customer { get; set; }
...
public sealed class MaxioCreateSubscriptionBody
{
    ...
    public MaxioNewSubscription? Subscription { get; set; }
