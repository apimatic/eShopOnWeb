...
public class ListContactNumbersEndpoint : IEndpoint<IResult, ListContactNumbersRequest, IShopperContactService>
{
    ...
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapGet("api/contact-numbers",
            ...
            {
                return await HandleAsync(new ListContactNumbersRequest(), contactService);
            })
            .Produces<ListContactNumbersResponse>()
            .WithTags("ContactNumberEndpoints");
    }

    public async Task<IResult> HandleAsync(ListContactNumbersRequest request, IShopperContactService contactService)
    {
        var httpContext = _httpContextAccessor.HttpContext!;
        var buyerId = EndpointUser.RequireBuyerId(httpContext.User);
        var numbers = await contactService.ListAsync(buyerId, httpContext.RequestAborted);
