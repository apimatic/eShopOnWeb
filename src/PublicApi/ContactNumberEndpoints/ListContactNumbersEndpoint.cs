...
public class ListContactNumbersEndpoint : IEndpoint<IResult, IShopperContactService>
{
    ...
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapGet("api/contact-numbers",
            ...
            (IShopperContactService service) =>
            {
    ...
    public async Task<IResult> HandleAsync(IShopperContactService service)
    {
        var httpContext = _httpContextAccessor.HttpContext!;
        var numbers = await service.ListAsync(BuyerIdentity.RequireBuyerId(httpContext), httpContext.RequestAborted);
