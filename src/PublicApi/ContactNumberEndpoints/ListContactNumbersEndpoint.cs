...
public class ListContactNumbersEndpoint : IEndpoint<IResult, IContactNumberService>
{
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapGet("api/contact-numbers",
            ...
            async (HttpContext httpContext, IContactNumberService contactNumbers) =>
            {
                ...
                return await HandleForBuyerAsync(buyerId, contactNumbers);
            })
    ...
    private static async Task<IResult> HandleForBuyerAsync(string buyerId, IContactNumberService contactNumbers)
    {
