...
public class ListContactNumbersEndpoint : IEndpoint<IResult, IShopperContactNumberService>
{
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapGet("api/contact-numbers",
            ...
            (ClaimsPrincipal user, IShopperContactNumberService service, CancellationToken cancellationToken) =>
            {
                var numbers = await service.ListForBuyerAsync(user.GetBuyerId(), cancellationToken);
