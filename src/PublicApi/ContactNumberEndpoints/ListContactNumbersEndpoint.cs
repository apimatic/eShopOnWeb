...
public class ListContactNumbersEndpoint : IEndpoint<IResult, IContactNumberService>
{
    ...
    public Task<IResult> HandleAsync(IContactNumberService service) => HandleAsync(service, null!);

    private async Task<IResult> HandleAsync(IContactNumberService service, HttpContext http)
    {
