...
public class DeleteContactNumberEndpoint : IEndpoint<IResult, int, IShopperContactNumberService>
{
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapDelete("api/contact-numbers/{contactNumberId}",
            ...
            async (int contactNumberId, ClaimsPrincipal user, IShopperContactNumberService service) =>
            {
    ...
    private async Task<IResult> HandleAsync(int contactNumberId, ClaimsPrincipal user, IShopperContactNumberService service)
    {
