...
/// nothing is ever sent to it again. Another shopper's number is simply not found here.
/// </summary>
public class DeleteContactNumberEndpoint : IEndpoint<IResult, int, IContactNumberService>
{
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapDelete("api/contact-numbers/{contactNumberId}",
            ...
            {
                var deleted = await service.DeleteAsync(user.GetBuyerId(), contactNumberId);
    ...
    // Not used: this endpoint acts entirely in the route lambda above.
