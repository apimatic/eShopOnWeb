...
public class DeleteContactNumberEndpoint : IEndpoint<IResult, int, IContactNumberService>
{
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapDelete("api/contact-numbers/{contactNumberId}",
            ...
            (int contactNumberId, IContactNumberService service, HttpContext httpContext) =>
            {
    ...
    private static async Task<IResult> HandleAsync(int contactNumberId, IContactNumberService service, HttpContext httpContext)
    {
        ...
        var deleted = await service.DeleteAsync(buyerId, contactNumberId, httpContext.RequestAborted);
