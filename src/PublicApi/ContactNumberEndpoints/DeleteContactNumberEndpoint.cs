...
/// numbers and nothing is ever sent to it again. Scoped to the owner — one shopper cannot delete
/// another's number.
/// </summary>
public class DeleteContactNumberEndpoint : IEndpoint<IResult, int, ClaimsPrincipal>
{
    ...
    public async Task<IResult> HandleAsync(int contactNumberId, ClaimsPrincipal user)
    {
        ...
        var deleted = await _contactNumberService.DeleteAsync(buyerId, contactNumberId, default);
