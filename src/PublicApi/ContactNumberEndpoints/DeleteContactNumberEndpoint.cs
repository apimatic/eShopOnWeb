...
public class DeleteContactNumberEndpoint : IEndpoint<IResult, DeleteContactNumberRequest, IContactNumberService>
{
    ...
    public async Task<IResult> HandleAsync(DeleteContactNumberRequest request, IContactNumberService contactNumberService, HttpContext httpContext)
    {
        await contactNumberService.DeleteAsync(httpContext.User.GetBuyerId(), request.ContactNumberId);
