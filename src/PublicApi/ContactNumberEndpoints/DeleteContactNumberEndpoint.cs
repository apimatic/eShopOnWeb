...
public class DeleteContactNumberEndpoint : IEndpoint<IResult, DeleteContactNumberRequest, IShopperContactNumberService>
{
    ...
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapDelete("api/contact-numbers/{contactNumberId:int}",
            ...
            (int contactNumberId, IShopperContactNumberService service) =>
            {
    ...
    public async Task<IResult> HandleAsync(DeleteContactNumberRequest request, IShopperContactNumberService service)
    {
