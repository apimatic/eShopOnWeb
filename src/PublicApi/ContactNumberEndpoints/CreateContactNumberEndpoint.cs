...
/// <summary>
/// Registers a mobile number for the signed-in shopper. The provider validates the number
/// and what gets stored is the provider's canonical form of it.
/// </summary>
public class CreateContactNumberEndpoint : IEndpoint<IResult, CreateContactNumberRequest, IContactNumberService>
{
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapPost("api/contact-numbers",
            ...
            {
                request.OwnerId = user.Identity?.Name ?? string.Empty;
    ...
    public async Task<IResult> HandleAsync(CreateContactNumberRequest request, IContactNumberService contactNumberService)
    {
        ...
        response.CreatedAt = contactNumber.CreatedAt;
