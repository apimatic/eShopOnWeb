...
public class CreateContactNumberEndpoint : IEndpoint<IResult, CreateContactNumberRequest, IContactNumberService>
{
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapPost("api/contact-numbers",
            ...
            (CreateContactNumberRequest request, IContactNumberService service, ClaimsPrincipal user, HttpContext http) =>
            {
        ...
        System.Threading.CancellationToken cancellationToken)
    {
        ...
        var contact = await service.RegisterAsync(buyerId, request.PhoneNumber, cancellationToken);
