...
public class CreateContactNumberEndpoint : IEndpoint<IResult, CreateContactNumberRequest, IShopperContactNumberService>
{
    ...
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapPost("api/contact-numbers",
            ...
            (CreateContactNumberRequest request, IShopperContactNumberService contacts) =>
            {
                return await HandleAsync(request, contacts);
            })
    ...
    public async Task<IResult> HandleAsync(CreateContactNumberRequest request, IShopperContactNumberService contacts)
    {
        ...
        try
        {
            var created = await contacts.RegisterAsync(buyerId, request.PhoneNumber, request.CountryCode, cancellationToken);
