...
/// </summary>
public class MySubscriptionsEndpoint : IEndpoint<IResult, ListMySubscriptionsRequest, ISubscriptionService>
{
    ...
    public async Task<IResult> HandleAsync(ListMySubscriptionsRequest request, ISubscriptionService subscriptionService)
    {
        ...
        response.Subscriptions.AddRange(await subscriptionService.ListMySubscriptionsAsync(request.Username));
