...
/// <summary>
/// List the authenticated user's subscriptions (UC1)
/// </summary>
public class MySubscriptionsEndpoint : IEndpoint<IResult, MySubscriptionsRequest, ISubscriptionService>
{
    ...
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapGet("api/subscriptions",
            ...
            {
                return await HandleAsync(new MySubscriptionsRequest(SubscriptionCaller.BuyerId(user)),
                    subscriptionService);
            })
        ...
        ISubscriptionService subscriptionService)
    {
        ...
        var subscriptions = await subscriptionService.GetSubscriptionsForUserAsync(request.BuyerId);
