...
/// <summary>
/// Lists the authenticated customer's own subscriptions.
/// </summary>
public class MySubscriptionsEndpoint : IEndpoint<IResult, MySubscriptionsRequest, ISubscriptionService>
{
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapGet("api/subscriptions/mine",
            ...
            (ISubscriptionService subscriptionService, HttpContext httpContext) =>
            {
                ...
                {
                    CustomerReference = SubscriptionEndpointHelpers.RequireCallerReference(httpContext.User)
                };
    ...
    public async Task<IResult> HandleAsync(MySubscriptionsRequest request, ISubscriptionService subscriptionService)
    {
        ...
        response.Subscriptions = subscriptions.Select(SubscriptionEndpointHelpers.ToDto).ToList();
