...
/// <summary>
/// Pauses (holds) a subscription's billing (UC4).
/// </summary>
public class PauseSubscriptionEndpoint : IEndpoint<IResult, LifecycleRequest, ISubscriptionService>
{
    ...
    {
        var subscription = await subscriptionService.PauseAsync(request.UserReference, request.IsAdmin, request.SubscriptionId);
