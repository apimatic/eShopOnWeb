...
/// </summary>
public class MySubscriptionsListEndpoint : IEndpoint<IResult, IMaxioService>
{
        ...
        app.MapGet("api/my-subscriptions",
            ...
            (IMaxioService maxioService, HttpContext httpContext) =>
            {
                ...
                response.Subscriptions.AddRange(subscriptions.Select(s => new SubscriptionDto
                {
                    ...
                    PricePerPeriod = s.ProductPriceInCents.HasValue
                        ? s.ProductPriceInCents.Value / 100.0m
                        : null,
