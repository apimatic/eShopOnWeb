...
/// <summary>
/// Lists the subscription plans available for enrollment (the products in the configured Maxio
/// product family).
/// </summary>
public class ListSubscriptionPlansEndpoint : IEndpoint<IResult, ISubscriptionBillingService>
{
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapGet("api/subscription-plans",
            ...
            .WithMetadata(new SwaggerOperationAttribute("Lists available subscription plans", "Returns the plans a shopper can subscribe to."));
    }
