...
public class ListMySubscriptionsEndpoint : IEndpoint<IResult, ISubscriptionBillingService>
{
    ...
    public async Task<IResult> HandleAsync(ISubscriptionBillingService billing)
    {
        ...
        var subscriptions = await billing.ListMySubscriptionsAsync(shopper.UserId, httpContext.RequestAborted);
        var response = new ListMySubscriptionsResponse();
        response.Subscriptions.AddRange(subscriptions.Select(ShopperIdentityFactory.ToDto));
