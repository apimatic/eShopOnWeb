...
/// <summary>
/// Lists the recurring plans available in the configured Maxio product family (UC1 step 1). Anonymous —
/// mirrors the read-only <c>CatalogItemListPagedEndpoint</c>, which likewise has no [Authorize].
/// </summary>
