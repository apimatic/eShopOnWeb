...
/// <summary>
/// List the available subscription plans (UC1 step 1). Anonymous — mirrors CatalogItemListPagedEndpoint.
/// </summary>
public class ListPlansEndpoint : IEndpoint<IResult, ISubscriptionService>
{
    ...
    public async Task<IResult> HandleAsync(ISubscriptionService subscriptionService)
    {
        ...
        response.Plans.AddRange(plans.Select(BillingPlanDto.FromDomain));
