...
public class CreateSubscriptionEndpoint : IEndpoint<IResult, CreateSubscriptionRequest, ISubscriptionBillingService>
{
    ...
    public async Task<IResult> HandleAsync(CreateSubscriptionRequest request, ISubscriptionBillingService billingService)
    {
        ...
        var customer = await BillingCustomerFactory.FromCurrentUserAsync(_httpContextAccessor, _userManager);
        var subscription = await billingService.SubscribeAsync(customer, request.ProductHandle.Trim());
