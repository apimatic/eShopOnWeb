...
/// <summary>
/// Operator action: disposes of the content of a message about a shopper. Afterwards the text is
/// no longer retrievable from the provider either — it is redacted there — while the fact a message
/// was sent, and what became of it, survives. Restricted to administrators.
/// </summary>
