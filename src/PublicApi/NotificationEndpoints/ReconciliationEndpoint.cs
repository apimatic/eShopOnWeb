...
/// <summary>
/// Operator: lists the provider's own record of messages (sent from this application's configured
/// sending number) over a date range and lines them up against what eShop believes it sent.
...
public class ReconciliationEndpoint : IEndpoint<IResult, IOrderNotificationService>
{
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapGet("api/notifications/reconciliation",
            ...
            (string? from, string? to, IOrderNotificationService service, HttpContext http) =>
            {
