...
/// <summary>
/// Operator: re-send a notification that did not reach the shopper. Repeating the same idempotency key does not send again.
/// </summary>
public class ResendNotificationEndpoint : IEndpoint<IResult, ResendNotificationRequest, IOrderNotificationService>
{
    ...
    public async Task<IResult> HandleAsync(ResendNotificationRequest request, IOrderNotificationService service)
    {
        ...
        var response = new ResendNotificationResponse(request.CorrelationId())
        {
            ...
            Notification = OrderNotificationDto.From(resent)
        };
