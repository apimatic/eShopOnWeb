...
/// <summary>
/// POST /api/orders/{orderId}/fulfil — operator action: mark the order fulfilled and capture
/// the held funds. Renews a stale authorization if needed. Administrators only.
/// </summary>
