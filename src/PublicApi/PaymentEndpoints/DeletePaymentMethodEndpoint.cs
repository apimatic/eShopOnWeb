...
/// among the caller's cards and can no longer be used to pay. Shopper-scoped.
/// </summary>
    ...
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapDelete("api/payment-methods/{paymentMethodId:int}",
                ...
                HttpContext http) =>
            {
                ...
                await savedCardService.DeleteCardAsync(buyerId, paymentMethodId, http.RequestAborted);
