...
/// </summary>
public record UpdateInvoiceItem
{
    ...
    /// <summary>
    /// Set to <c>true</c> together with <c>uid</c> to remove the matching line item from the invoice. Line items not referenced in the request remain unchanged.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
