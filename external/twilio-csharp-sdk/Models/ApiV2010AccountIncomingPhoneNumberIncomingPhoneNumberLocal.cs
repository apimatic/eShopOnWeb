...
public record ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal
{
    /// <summary>
    ...
    public IncomingPhoneNumberLocalEnumAddressRequirement? AddressRequirements { get; init; }
    ...
    public Capabilities7? Capabilities { get; init; }
    ...
    /// <summary>
    /// The phone number's origin. <c>twilio</c> identifies Twilio-owned phone numbers and <c>hosted</c> identifies hosted phone numbers.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("voice_receive_mode")]
    public IncomingPhoneNumberLocalEnumVoiceReceiveMode? VoiceReceiveMode { get; init; }
    ...
    /// <summary>
    /// Whether we look up the caller's caller-ID name from the CNAM database ($0.01 per look up). Can be: <c>true</c> or <c>false</c>.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    /// <summary>
    /// The URL we call when this phone number receives a call. The <c>voice_url</c> will not be used if a <c>voice_application_sid</c> or a <c>trunk_sid</c> is set.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    public IncomingPhoneNumberLocalEnumEmergencyStatus? EmergencyStatus { get; init; }
    ...
    public IncomingPhoneNumberLocalEnumEmergencyAddressStatus? EmergencyAddressStatus { get; init; }
