...
public record ApiV2010AccountConferenceConferenceRecording
{
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/iam/api/account">Account</see> that created the Conference Recording resource.
    /// </summary>
    ...
    /// <summary>
    /// The SID of the <see href="https://www.twilio.com/docs/voice/api/call-resource">Call</see> the Conference Recording resource is associated with.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    public ConferenceRecordingEnumStatus? Status { get; init; }
    ...
    public ConferenceRecordingEnumSource? Source { get; init; }
