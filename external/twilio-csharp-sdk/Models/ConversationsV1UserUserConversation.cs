...
public record ConversationsV1UserUserConversation
{
    /// <summary>
    ...
    public UserConversationEnumState? ConversationState { get; init; }
    ...
    public UserConversationEnumNotificationLevel? NotificationLevel { get; init; }
