...
public record ContentV1LegacyContent1
{
    /// <summary>
    ...
    /// <summary>
    /// The <see href="https://www.twilio.com/docs/content/content-types-overview">Content types</see> (e.g. twilio/text) for this Content resource.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("legacy_template_name")]
    public string? LegacyTemplateName { get; init; }

    /// <summary>
    /// The string body field of the legacy content template associated with this Content resource
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("legacy_body")]
    public string? LegacyBody { get; init; }

    /// <summary>
    /// The URL of the resource, relative to <c>https://content.twilio.com</c>.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
