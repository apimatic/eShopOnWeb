...
public record NumbersV1PortingWebhookConfigurationFetch
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("port_in_target_date_created")]
    public DateTimeOffset? PortInTargetDateCreated { get; init; }

    /// <summary>
    /// Creation date for the port out webhook configuration
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("port_out_target_date_created")]
    public DateTimeOffset? PortOutTargetDateCreated { get; init; }
