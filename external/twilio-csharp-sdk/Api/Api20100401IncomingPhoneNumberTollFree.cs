...
public sealed class Api20100401IncomingPhoneNumberTollFree
{
    private readonly RawClient _rawClient;
    private readonly Server _server;
    private readonly AuthSchemes _auth;

    internal Api20100401IncomingPhoneNumberTollFree(RawClient rawClient, Server server, AuthSchemes auth)
    {
    ...
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task<ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree> CreateIncomingPhoneNumberTollFree(string accountSid,
        string phoneNumber,
        string? apiVersion,
        string? friendlyName,
        ...
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/TollFree.json"),
            ...
            JsonResponse.Create<ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree>(),
    ...
    /// <param name="requestOptions">Per-request options, such as an overriding log level for this call</param>
    /// <param name="ct">Cancellation token</param>
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ListIncomingPhoneNumberTollFreeResponse"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="RawError"/> when the server returns an error response.</exception>
    public Task<ListIncomingPhoneNumberTollFreeResponse> ListIncomingPhoneNumberTollFree(string accountSid,
        bool? beta,
        string? friendlyName,
        string? phoneNumber,
        string? origin,
        ...
        _rawClient.Execute(_server.Default("/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/TollFree.json"),
            ...
            HttpMethod.Get,
            EmptyBody.Instance,
            JsonResponse.Create<ListIncomingPhoneNumberTollFreeResponse>(),
            RawErrorResponse.Instance,
            [_auth.AccountSidAuthToken],
            requestOptions,
            ct);
