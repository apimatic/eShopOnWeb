...
public record CrawlStatusResponseObj
{
    /// <summary>
    /// The current status of the crawl. Can be <c>scraping</c>, <c>completed</c>, or <c>failed</c>.
    /// </summary>
    ...
    /// <summary>
    /// The date and time when the crawl finished. Present only when the crawl is in a terminal state (<c>completed</c>, <c>failed</c>, or <c>cancelled</c>).
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    /// <summary>
    /// Crawl duration in seconds. For terminal crawls, this is the elapsed time from <c>createdAt</c> to <c>completedAt</c>. For in-progress crawls, it is the elapsed time from <c>createdAt</c> to now.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
