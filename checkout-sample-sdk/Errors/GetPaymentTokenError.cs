...
public sealed class GetPaymentTokenError : ApiError
{
    ...
    private GetPaymentTokenError(Optional<Error1> error1Value, Optional<RawError> fallback) : base(fallback)
    {
        _error1Value = error1Value;
    }

    private static GetPaymentTokenError AsError1(Error1 value) =>
