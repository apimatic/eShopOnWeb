...
public class TestApiApplication : WebApplicationFactory<AuthenticateEndpoint>
{
    ...
    protected override IHost CreateHost(IHostBuilder builder)
    {
        ...
        // Placeholder Twilio config so the startup fail-fast validation passes when the host boots.
        // These are non-secret dummy values; no Twilio endpoint is exercised by these tests.
