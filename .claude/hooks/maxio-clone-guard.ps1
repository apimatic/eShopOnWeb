...
# transcript audit is the backstop. Experiment-only (wired for the maxio-sdk-clone and
# maxio-sdk-merged arms via new-run.ps1 -EnforceClone); does NOT ship in the plugin.
