...
# Allow ONLY the two SDK-owning subagents (matches plugin-scoped
# 'maxio-sdk-clone:maxio-plan' and bare 'maxio-plan' forms).
$agent = [string]$evt.agent_type
if ($agent -match 'maxio-(plan|debug)') { exit 0 }
